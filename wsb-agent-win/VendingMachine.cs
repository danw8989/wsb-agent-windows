...
namespace wsb_agent_win
{
    ...
    public class VendingMachine
    {
        ...
        public string BuyProduct(int productCode)
        {
            string tmp = "";
            if ( IsWorking )
            {
                ...
                {                
                    tmp = "Zakupiono " + Slots[productCode].Name + " za " + Slots[productCode].Price + " zł" + " Zostało " + ( Slots[productCode].Count - 1 ) + "/" + SlotDepthness + " Automat na ulicy: " + Adress;
